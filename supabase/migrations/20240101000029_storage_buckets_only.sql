-- Storage Buckets Only Migration
-- Creates storage buckets for user references and other assets
...
DROP POLICY IF EXISTS "Anyone can view workflow assets" ON storage.objects;
DROP POLICY IF EXISTS "Authenticated users can upload workflow assets" ON storage.objects;
DROP POLICY IF EXISTS "Authenticated users can update workflow assets" ON storage.objects;
DROP POLICY IF EXISTS "Authenticated users can delete workflow assets" ON storage.objects;
