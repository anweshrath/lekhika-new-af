class QueueAdapter {
  ...
  /**
   * Clear waiting jobs from the queue (jobs not yet started).
   */
  // eslint-disable-next-line no-unused-vars
  async clearWaiting() {
    throw new Error('clearWaiting() not implemented');
  }

  /**
   * Hard reset the queue: pause processing and remove all non-active jobs.
   * Implementations should NOT silently ignore errors.
   */
  // eslint-disable-next-line no-unused-vars
  async resetAll() {
